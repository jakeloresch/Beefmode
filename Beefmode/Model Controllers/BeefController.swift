...
//
//        var urlComponents = URLComponents(url: BeefController.baseURL!, resolvingAgainstBaseURL: true)
...
//                let postsDictionary = try decoder.decode([String:Beef].self, from: data)
//                let posts: [Beef] = postsDictionary.flatMap( { $0.value })
...
//
//            let post = Beef(username: username, text: text)
//
//            var postData: Data
//
//
...
//            }
//
//            let postEndPoint = BeefController.baseURL?.appendingPathExtension("json")
//
